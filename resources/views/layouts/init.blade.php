...
<html lang="en">
	...
	<body class="no-skin">
		...
		<script src="{{asset('plugin/assets/js/bootstrap-datepicker.min.js')}}"></script>
		<script src="{{asset('plugin/assets/js/bootstrap-timepicker.min.js')}}"></script>
		<script src="{{asset('plugin/assets/js/moment.min.js')}}"></script>
		<script src="{{asset('plugin/assets/js/daterangepicker.min.js')}}"></script>
		<script src="{{asset('plugin/assets/js/bootstrap-datetimepicker.min.js')}}"></script>
		<script src="{{asset('plugin/assets/js/bootstrap-colorpicker.min.js')}}"></script>
		<script src="{{asset('plugin/assets/js/jquery.knob.min.js')}}"></script>
		<script src="{{asset('plugin/assets/js/autosize.min.js')}}"></script>
		<script src="{{asset('plugin/assets/js/jquery.inputlimiter.min.js')}}"></script>
